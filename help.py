...
def state_city(state = "0", city = "0", blurb1 = "insert here", blurb2 = "insert here"):
    t1, t2 = st.tabs(["By State", "By City"])
    if city == "0":
        with t1:
            st.write("Map missing!")
    else:
        with t1:
                fig = choropleth_state_map(state)
                st.header(blurb1)
                st.plotly_chart(fig)
    if state == "0":
        with t2:
        ...
        with t2:
            fig = display_city_visualization(city)
            st.header(blurb2)
            st.plotly_chart(fig) 
    ...
    if ["All Engineering Majors"] == ms:
        if ["2023"] == ms1:
            ...
            with tab2:
                st.image("2023 (1).jpg")
            with tab3:
                state_city("CSV_Spring 2023_3-7-24.csv", "0")
        elif ["2022"] == ms1:
            tab1, tab2, tab3 = st.tabs(["Key Statistics", "By Employer", "By Geography"])
            with tab1:
        ...
        if ["2023"] == ms1:
            ...
            with t1:
                ...
                tab1, tab2, tab3 = st.tabs(["Major", "Ethnicity", "Gender"])
                with tab1:
                    data_major(hex_colors(4), Major2022)
                with tab2:
            ...
            with t1:
                ...
                tab1, tab2, tab3 = st.tabs(["Major", "Ethnicity", "Gender"])
                with tab1:
                    data_major(hex_colors(3, 1), Major2021, MajorList2021)
                with tab2:
        ...
        if ["2023"] == ms1:
            ...
            with t1:
                ...
                tab1, tab2, tab3 = st.tabs(["Major", "Ethnicity", "Gender"])
                with tab1:
                    data_major(hex_colors(6), Major2022)
                with tab2:
            ...
            with t1:
                ...
                tab1, tab2, tab3 = st.tabs(["Major", "Ethnicity", "Gender"])
                with tab1:
                    data_major(hex_colors(5, 1), Major2021, MajorList2021)
                with tab2:
        ...
        if ["2023"] == ms1:
            ...
            with t1:
                ...
                tab1, tab2, tab3 = st.tabs(["Major", "Ethnicity", "Gender"])
                with tab1:
                    data_major(hex_colors(2), Major2022)
                with tab2:
            ...
            with t1:
                ...
                tab1, tab2, tab3 = st.tabs(["Major", "Ethnicity", "Gender"])
                with tab1:
                    data_major(hex_colors(2, 1), Major2021, MajorList2021)
                with tab2:
        ...
        if ["2023"] == ms1:
            ...
            with t1:
                ...
                tab1, tab2, tab3 = st.tabs(["Major", "Ethnicity", "Gender"])
                with tab1:
                    data_major(hex_colors(5), Major2022)
                with tab2:
            ...
            with t1:
                ...
                tab1, tab2, tab3 = st.tabs(["Major", "Ethnicity", "Gender"])
                with tab1:
                    data_major(hex_colors(6, 1), Major2021, MajorList2021)
                with tab2:
        ...
        if ["2023"] == ms1:
            ...
            with t1:
                ...
                tab1, tab2, tab3 = st.tabs(["Major", "Ethnicity", "Gender"])
                with tab1:
                    data_major(hex_colors(-1), Major2022)
                with tab2:
        ...
        if ["2023"] == ms1:
            ...
            with t1:
                ...
                tab1, tab2, tab3 = st.tabs(["Major", "Ethnicity", "Gender"])
                with tab1:
                    data_major(hex_colors(7), Major2022)
                with tab2:
            ...
            with t1:
                ...
                tab1, tab2, tab3 = st.tabs(["Major", "Ethnicity", "Gender"])
                with tab1:
                    data_major(hex_colors(7,1), Major2021, MajorList2021)
                with tab2:
        ...
        if ["2023"] == ms1:
            ...
            with t1:
                ...
                tab1, tab2, tab3 = st.tabs(["Major", "Ethnicity", "Gender"])
                with tab1:
                    data_major(hex_colors(0), Major2022)
                with tab2:
            ...
            with t1:
                ...
                tab1, tab2, tab3 = st.tabs(["Major", "Ethnicity", "Gender"])
                with tab1:
                    data_major(hex_colors(0), Major2021, MajorList2021)
                with tab2:
        ...
        if ["2023"] == ms1:
            ...
            with t1:
                ...
                tab1, tab2, tab3 = st.tabs(["Major", "Ethnicity", "Gender"])
                with tab1:
                    data_major(hex_colors(3), Major2022)
                with tab2:
            ...
            with t1:
                ...
                tab1, tab2, tab3 = st.tabs(["Major", "Ethnicity", "Gender"])
                with tab1:
                    data_major(hex_colors(4), Major2021, MajorList2021)
                with tab2:
        ...
        if ["2023"] == ms1:
            ...
            with t1:
                ...
                tab1, tab2, tab3 = st.tabs(["Major", "Ethnicity", "Gender"])
                with tab1:
                    data_major(hex_colors(-1,1), Major2021, MajorList2021)
                with tab2:
